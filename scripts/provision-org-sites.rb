...
def open_pr(repo, cfg, clone, changed, direct:)
  ...
  Dir.chdir(clone) do
    ...
    if existing.empty?
      body = <<~BODY
        Adds the GitHub Pages scaffold generated by the hub's
        [scripts/provision-org-sites.rb](https://github.com/#{org}/#{org}.github.io/blob/main/scripts/provision-org-sites.rb):
